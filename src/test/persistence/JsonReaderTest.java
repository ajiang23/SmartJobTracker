...
class JsonReaderTest extends JsonTest {
    ...
    void testReaderGeneralJobAppList() {
        ...
        try {
            ...
            checkJobApplication("Google", "Specialist", LocalDate.of(2025, 01, 01), resume1, "google.ca", null, "",
                    JobStatus.Applied, jl.getList().get(0));
            checkJobApplication("Sony", "Manager", LocalDate.of(2025, 02, 21), resume2, "sony.ca", cl, "test notes",
                    JobStatus.Rejected, jl.getList().get(1));
        } catch (IOException notValid) {
            fail("File reading error.");
        }
    }
